...
(function (root, factory) {
    ...
    */
    ...
    function Cg(a) {
        ...
        this.c = null;
        "string" === typeof c ? (this.c = document.createElement("img"), this.c.src = a.label, this.c.style.width = "100%", this.c.textContent = c) : (this.c = c, this.c.classList.add("ol-compass"));
